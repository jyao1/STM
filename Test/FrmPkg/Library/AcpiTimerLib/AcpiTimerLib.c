...
/**
  ...
  This function returns ACPI timer width.

  @return ACPI timer width.
...
{
  return PcdGet8 (PcdAcpiTimerWidth);
}
...
{
  return IoRead32 (PcdGet16 (PcdAcpiTimerIoPortBaseAddress));
}
  ...
  )
{
  ...
  if (EndValue != NULL) {
    *EndValue = (1 << GetAcpiTimerWidth()) - 1;
  }

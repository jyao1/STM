...
//
// Definition for Remapping Hardware Status Affinity (RHSA) Structure
//
#define EFI_ACPI_DMAR_ATSR_FLAGS_ALL_PORTS_SET     0x1
#define EFI_ACPI_DMAR_ATSR_FLAGS_ALL_PORTS_CLEAR   0x0
typedef struct {
...
} EFI_ACPI_DMAR_REMAPPING_HARDWARE_STATUS_AFFINITY_STRUCTURE;
...
typedef union {
  ...
  EFI_ACPI_DMAR_REMAPPING_HARDWARE_STATUS_AFFINITY_STRUCTURE   DMARRemappingHardwareStatusAffinity;
...
#define EFI_ACPI_DMAR_TABLE_FLAGS_X2APIC_OPT_OUT_SET        0x02
typedef struct {
